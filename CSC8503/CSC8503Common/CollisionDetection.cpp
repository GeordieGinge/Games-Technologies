...
bool CollisionDetection::RayIntersection(const Ray& r,
	GameObject& object, RayCollision& collision) 
{
...
bool CollisionDetection::RayOBBIntersection(const Ray& r,
	...
	Matrix3 transform =    Matrix3(orientation.ToMatrix3());
...
bool CollisionDetection::AABBTest(
